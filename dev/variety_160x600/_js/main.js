...
function start(){
	...
	const rings = [
		{id:".ring1", offsetY:0, offsetX:80, scale:1},
		{id:".ring2", offsetY:0, offsetX:80, scale:1},
		{id:".ring3", offsetY:0, offsetX:80, scale:1},
		{id:".ring4", offsetY:0, offsetX:80, scale:1},
		{id:".ring5", offsetY:0, offsetX:80, scale:1},		
	]
